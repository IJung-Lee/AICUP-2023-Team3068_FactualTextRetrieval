...
def chef_test_train():
    ...
    # 放入要儲存的位置
    with open('..\Sentence_retrieval_result\CHEF_wiki_train_0511SBDA50e0519_BM25Fv3ALL_0607.json', 'w', encoding='utf-8') as f:
...
def claim_cossim():
    ...
    # 放入要儲存的位置
    with open('..\Sentence_retrieval_result\CHEF_wiki_claim_cossim_0511SBDA50e0519_BM25Fv3ALL_0607.json', 'w', encoding='utf-8') as f:
